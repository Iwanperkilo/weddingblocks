            ...
            return [
                el(InspectorControls, { key: 'inspector' },
                    el(PanelBody, {
                        ...
                        el('p', { style: { marginBottom: '8px', fontWeight: '500' } }, __('Warna Angka', 'weddingblocks')),
                        el(ColorPalette, {
                            value: textColor,
                            colors: colorPalette,
                        ...
                        el('p', { style: { margin: '16px 0 8px', fontWeight: '500' } }, __('Warna Label', 'weddingblocks')),
                        el(ColorPalette, {
                            value: labelColor,
                            colors: colorPalette,
                            onChange: function (value) {
                        ...
                        el('p', { style: { margin: '16px 0 8px', fontWeight: '500' } }, __('Warna Background Box', 'weddingblocks')),
                        el(ColorPalette, {
                        ...
                        el('p', { style: { margin: '16px 0 8px', fontWeight: '500' } }, __('Warna Border', 'weddingblocks')),
                        el(ColorPalette, {
                            value: borderColor,
                            colors: colorPalette,
                            onChange: function (value) {
                ...
                el('div', useBlockProps({ key: 'editor-preview', className: 'weddingblocks-countdown-editor' }),
                    ...
                    el('div', { className: 'weddingblocks-countdown' },
                        el('div', { className: 'countdown-item', style: { backgroundColor: boxBackgroundColor, borderColor: borderColor } },
                            el('span', { className: 'countdown-value', style: { color: textColor } }, '00'),
                            el('span', { className: 'countdown-label', style: { color: labelColor } }, __('Hari', 'weddingblocks'))
                        ),
                        el('div', { className: 'countdown-item', style: { backgroundColor: boxBackgroundColor, borderColor: borderColor } },
                            el('span', { className: 'countdown-value', style: { color: textColor } }, '00'),
                            el('span', { className: 'countdown-label', style: { color: labelColor } }, __('Jam', 'weddingblocks'))
                        ),
                        el('div', { className: 'countdown-item', style: { backgroundColor: boxBackgroundColor, borderColor: borderColor } },
                            el('span', { className: 'countdown-value', style: { color: textColor } }, '00'),
                            el('span', { className: 'countdown-label', style: { color: labelColor } }, __('Menit', 'weddingblocks'))
                        ),
                        el('div', { className: 'countdown-item', style: { backgroundColor: boxBackgroundColor, borderColor: borderColor } },
                            el('span', { className: 'countdown-value', style: { color: textColor } }, '00'),
                            el('span', { className: 'countdown-label', style: { color: labelColor } }, __('Detik', 'weddingblocks'))
                        )
                    )
                )
            ];
