(function (blocks, element, blockEditor, components, i18n) {
  ...
  blocks.registerBlockType("weddingblocks/countdown", {
    edit: function (props) {
      ...
      var valueFontSize = typeof attributes.valueFontSize === "number" ? attributes.valueFontSize : 32;
      var labelFontSize = typeof attributes.labelFontSize === "number" ? attributes.labelFontSize : 10;
      var gap = typeof attributes.gap === "number" ? attributes.gap : 15;
      var boxPaddingVertical = typeof attributes.boxPaddingVertical === "number" ? attributes.boxPaddingVertical : 15;
      var boxPaddingHorizontal = typeof attributes.boxPaddingHorizontal === "number" ? attributes.boxPaddingHorizontal : 5;
      var labelDays = attributes.labelDays || __("Hari", "weddingblocks");
      var labelHours = attributes.labelHours || __("Jam", "weddingblocks");
      var labelMinutes = attributes.labelMinutes || __("Menit", "weddingblocks");
      ...
      return [
        el(
          ...
          el(PanelBody, { title: __("Pengaturan Box & Tipografi", "weddingblocks"), initialOpen: false },
            el(RangeControl, { label: __("Ketebalan Border (px)", "weddingblocks"), value: borderWidth, min: 0, max: 8, onChange: function (v) { setAttributes({ borderWidth: v === undefined ? 1 : v }); } }),
            el(RangeControl, { label: __("Border Radius (px)", "weddingblocks"), value: borderRadius, min: 0, max: 50, onChange: function (v) { setAttributes({ borderRadius: v === undefined ? 15 : v }); } }),
            el(ToggleControl, { label: __("Aktifkan Box Shadow", "weddingblocks"), checked: boxShadow, onChange: function (v) { setAttributes({ boxShadow: v }); } }),
            el(RangeControl, { label: __("Ukuran Font Angka (px)", "weddingblocks"), value: valueFontSize, min: 16, max: 60, onChange: function (v) { setAttributes({ valueFontSize: v === undefined ? 32 : v }); } }),
            el(RangeControl, { label: __("Ukuran Font Label (px)", "weddingblocks"), value: labelFontSize, min: 8, max: 20, onChange: function (v) { setAttributes({ labelFontSize: v === undefined ? 10 : v }); } }),
            el(RangeControl, { label: __("Jarak Antar Box (px)", "weddingblocks"), value: gap, min: 0, max: 40, onChange: function (v) { setAttributes({ gap: v === undefined ? 15 : v }); } }),
            el(RangeControl, { label: __("Padding Atas-Bawah Box (px)", "weddingblocks"), value: boxPaddingVertical, min: 0, max: 40, onChange: function (v) { setAttributes({ boxPaddingVertical: v === undefined ? 15 : v }); } }),
            el(RangeControl, { label: __("Padding Kiri-Kanan Box (px)", "weddingblocks"), value: boxPaddingHorizontal, min: 0, max: 40, onChange: function (v) { setAttributes({ boxPaddingHorizontal: v === undefined ? 5 : v }); } })
          ),
          el(PanelBody, { title: __("Teks Label", "weddingblocks"), initialOpen: false },
            el(TextControl, { label: __("Label Hari", "weddingblocks"), value: labelDays, onChange: function (v) { setAttributes({ labelDays: v }); } }),
            el(TextControl, { label: __("Label Jam", "weddingblocks"), value: labelHours, onChange: function (v) { setAttributes({ labelHours: v }); } }),
            el(TextControl, { label: __("Label Menit", "weddingblocks"), value: labelMinutes, onChange: function (v) { setAttributes({ labelMinutes: v }); } }),
            el(TextControl, { label: __("Label Detik", "weddingblocks"), value: labelSeconds, onChange: function (v) { setAttributes({ labelSeconds: v }); } })
          )
        ),
        animPanel,
        el(
          "div",
          useBlockProps({ key: "editor-preview", className: "weddingblocks-countdown-editor" }),
          el(
            "div",
            { className: "weddingblocks-countdown", style: { gap: gap + "px" } },
            makeItem(labelDays),
            makeItem(labelHours),
