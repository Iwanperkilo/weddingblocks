                    ...
                    el(PanelBody, { title: __("Pengaturan Nama Mempelai", "weddingblocks"), initialOpen: true },
                        ...
                        el(SelectControl, {
                            ...
                            options: [
                                ...
                                { label: __("Nama Panggilan", "weddingblocks"), value: "nickname" },
                        ...
                        el(SelectControl, {
                            ...
                            options: [
                                ...
                                { label: __("HURUF BESAR (UPPERCASE)", "weddingblocks"), value: "uppercase" },
                                { label: __("Huruf Besar Di Awal (Capitalize)", "weddingblocks"), value: "capitalize" },
                                { label: __("huruf kecil (lowercase)", "weddingblocks"), value: "lowercase" }
                            ],
                            onChange: function (v) { props.setAttributes({ textTransform: v }); }
                        }),
                        el("p", { style: { marginBottom: "5px", fontWeight: "500" } }, __("Warna Nama", "weddingblocks")),
                        el(ColorPalette, {
                            value: textColor,
                            colors: customColors,
                            onChange: function (v) { props.setAttributes({ textColor: v || "#b5a46d" }); }
                        })
                    )
                ),
