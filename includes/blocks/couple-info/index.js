(function (blocks, element, blockEditor, i18n, components) {
  ...
  blocks.registerBlockType("weddingblocks/couple-info", {
    edit: function (props) {
      ...
      var placeholderSvg =
        'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23b5a46d" preserveAspectRatio="xMidYMax meet"><path d="M12 12c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm0 2c-3.33 0-10 1.67-10 5v5h20v-5c0-3.33-6.67-5-10-5z"/></svg>';

      var groomName =
        meta.weddingblocks_groom_name || __("Mempelai Pria", "weddingblocks");
      var groomParents =
        meta.weddingblocks_groom_parents ||
        __("Putra dari Bapak & Ibu Orang Tua Pria", "weddingblocks");
      var groomPhoto = meta.weddingblocks_groom_photo || placeholderSvg;

      var brideName =
        meta.weddingblocks_bride_name || __("Mempelai Wanita", "weddingblocks");
      var brideParents =
        meta.weddingblocks_bride_parents ||
        __("Putri dari Bapak & Ibu Orang Tua Wanita", "weddingblocks");
      ...
      return el(
        ...
        el(
          ...
          el(
            PanelBody,
            {
              title: __("Pengaturan Layout dan Urutan", "weddingblocks"),
              initialOpen: true,
            },
            el(ToggleControl, {
            ...
            el(SelectControl, {
              ...
              options: [
                {
                  value: "horizontal",
                  label: __("Horizontal", "weddingblocks"),
                },
            ...
            PanelColorSettings,
            {
              ...
              colorSettings: [
                ...
                },
                {
                  ...
                  label: __("Warna Label & Nama Orang Tua", "weddingblocks"),
                  colors: LABEL_TEXT_COLORS,
                },
              ],
            },
          ...
          el(
            PanelBody,
            {
              title: __("Label & Nama Orang Tua", "weddingblocks"),
              initialOpen: false,
            },
            el(ToggleControl, {
