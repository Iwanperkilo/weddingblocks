(function (blocks, element, blockEditor, components, i18n) {
    ...
    blocks.registerBlockType('weddingblocks/cover', {
        edit: function (props) {
            ...
            var COVER_TEMPLATE = [
                ['core/paragraph', { placeholder: 'WALIMATUL \'URSY', className: 'weddingblocks-cover-welcome', align: 'center' }],
                ['core/heading', { placeholder: 'Mempelai Pria & Mempelai Wanita', className: 'weddingblocks-cover-title', textAlign: 'center', level: 1 }],
                ['weddingblocks/guest-name', { prefix: 'Kepada Yth. Bapak/Ibu/Saudara/i:', fallback: 'Tamu Undangan' }]
            ];

            return [
                el(InspectorControls, { key: 'inspector' },
                    el(PanelBody, { title: __('Pengaturan Cover', 'weddingblocks'), initialOpen: true },
                        ...
                        el(MediaUpload, {
                            ...
                            render: function (obj) {
                                return el('div', {},
                                    ...
                                    }, !attributes.backgroundImage ? __('Pilih Gambar', 'weddingblocks') : __('Ganti Gambar', 'weddingblocks')),
                    ...
                    el(PanelBody, { title: __('Tampilan & Warna', 'weddingblocks'), initialOpen: false },
                        ...
                        el('p', { style: { fontWeight: '600', marginBottom: '5px' } }, __('Warna Overlay:', 'weddingblocks')),
                        el(ColorPalette, {
                            colors: customColors,
                        ...
                        el('p', { style: { fontWeight: '600', marginBottom: '5px' } }, __('Warna Aksen & Tombol:', 'weddingblocks')),
                        el(ColorPalette, {
                            colors: customColors,
                ...
                el('div', useBlockProps({
                    ...
                    style: {
                        ...
                        backgroundColor: attributes.backgroundImage ? 'transparent' : (attributes.overlayColor || '#1c1d1d'),
                    ...
                    el('div', {
                        style: {
                            ...
                            opacity: (attributes.overlayOpacity !== undefined ? attributes.overlayOpacity : 35) / 100,
                            zIndex: 1
                        }
                    }),
                    // Content Wrapper
